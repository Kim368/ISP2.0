CUR_PATH = "D:\\work\\documents\\Study\\BSUIR\\Python\\Test\\"
SOURCE_NAME = "Function_Source.txt"
CODE_NAME = "Function_Code.txt"
...
def SaveFunction(f):
    sourcecode.function_dump(f, CUR_PATH + SOURCE_NAME)
    attrcode.function_dump(f, CUR_PATH + CODE_NAME)


def LoadFunction():
    fs = sourcecode.function_load(CUR_PATH + SOURCE_NAME)
    fc = attrcode.function_load(CUR_PATH + CODE_NAME)
    return (fs, fc)
